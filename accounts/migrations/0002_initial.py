...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_userprofile', (
            ...
            ('display_name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True)),
            ('updated_profile', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
    ...
    models = {
        u'accounts.userprofile': {
            ...
            'display_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50', 'null': 'True'}),
            'updated_profile': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
